...
class Actor(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.layer_3 = nn.Linear(800, 400)
        self.layer_4 = nn.Linear(400, action_dim)
...
class Critic(nn.Module):
    ...
    def __init__(self, state_dim, action_dim):
        ...
        self.layer_1 = nn.Linear(state_dim + action_dim, 1200)
        self.layer_2 = nn.Linear(1200, 800)
        self.layer_3 = nn.Linear(800, 400)
        self.layer_4 = nn.Linear(400, 1)

        # Second critic network
        self.layer_5 = nn.Linear(state_dim + action_dim, 1200)
        self.layer_6 = nn.Linear(1200, 800)
        self.layer_7 = nn.Linear(800, 400)
        self.layer_8 = nn.Linear(400, 1)
